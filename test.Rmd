...
plot_contour_with_path <- function(f, range_x, range_y, history) {
  ...
  filled.contour(x_seq, y_seq, log(z + 1), nlevels = 50, color.palette = viridis::viridis,
                 ...
                 plot.axes = {
                   ...
                   lines(history[,1], history[,2], col = "orange", type = "l")
...
result <- gradient_descent(my_function_vec, start_value = c(0, 0), max_iter = 100, gamma = 0.000595)
...
result <- gradient_descent(three_hump_camel, start_value = c(4, 4), max_iter = 1000, gamma = 0.0000595)
